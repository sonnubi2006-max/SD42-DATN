...
export default function ListProductVariantPage() {
  ...
  return (
    <div className="space-y-6">
      {}
      <div>
        <h1 className="text-xl font-semibold text-foreground">Biến thể sản phẩm</h1>
